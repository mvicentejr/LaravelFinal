...
@section('content')
    <div class="jumbotron bg-secondary border boder-light">
            ...
            <div class="col-md-12 mx-auto mt-5">
                    ...
                    <div class="card-deck">
                                    ...
                                    <div class="card border border-dark">
                                        ...
                                        <a href="{{route('clientes.index')}}" class="btn btn-primary btn-lg btn-block">MANUTENÇÃO</a>
                                        </div>
                                    </div>
        ...
        {{-- <br><br> --}}
        {{-- <a href="{{route('home')}}" class="btn btn-danger btn-larg btn-block"><h4>VOLTAR AO MENU PRINCIPAL</h4></a> --}}
    </div>
@endsection
